	...
	return (
		<>
			<meta
				...
				content='8TRi_yA8pcOP7kEIGljcMNl5-ef84YxEgH3-9oU4OJk'
			/>
			<Head>
				<title>No Spend Challenge - Stop Impulsive Buying</title>
				<meta
					name='description'
					content='Join the No Spend Challenge and learn how to save money effectively. Take control of your finances today!'
				/>
				<link rel='canonical' href='https://nospendchallenge.app/' />
			</Head>
			<Navbar
				navLight={false}
				playBtn={false}
